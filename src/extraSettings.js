...
// 指定生成的水果
const minRandomFruitNum = 1; // 生成随机水果最小值（0-10）
const maxRandomFruitNum = 5; // 生成随机水果最大值（1-11）
let setFruits = {
  startFruits: [1, 1, 1, 2, 2, 3], // 指定前几次生成的水果，可填入任意数量的数字
  randomFunction: () => {
...
let adLink = 'res/video.mp4';

// 修改网页标题：将 "合成大西瓜" 进行替换
document.getElementsByTagName("title")[0].innerText = '合成czl';
